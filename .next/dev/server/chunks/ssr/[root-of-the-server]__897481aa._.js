...
class ConversationalAIAPI extends __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$utils$2f$event$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EventHelper"] {
   ...
   */ async interrupt(agentUserId) {
    ...
    onChatHistoryUpdated(chatHistory) {
        this.callMessagePrint(ELoggerType.debug, `>>> ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EConversationalAIAPIEvents"].TRANSCRIPT_UPDATED}`, chatHistory);
    ...
    onAgentStateChanged(agentUserId, event) {
        this.callMessagePrint(ELoggerType.debug, `>>> ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EConversationalAIAPIEvents"].AGENT_STATE_CHANGED}`, agentUserId, event);
    ...
    onAgentInterrupted(agentUserId, event) {
        this.callMessagePrint(ELoggerType.debug, `>>> ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EConversationalAIAPIEvents"].AGENT_INTERRUPTED}`, agentUserId, event);
    ...
    onAgentMetrics(agentUserId, metrics) {
        this.callMessagePrint(ELoggerType.debug, `>>> ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EConversationalAIAPIEvents"].AGENT_METRICS}`, agentUserId, metrics);
    ...
    onAgentError(agentUserId, error) {
        this.callMessagePrint(ELoggerType.error, `>>> ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EConversationalAIAPIEvents"].AGENT_ERROR}`, agentUserId, error);
    ...
    onMessageReceiptUpdated(agentUserId, messageReceipt) {
        this.callMessagePrint(ELoggerType.error, `>>> ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EConversationalAIAPIEvents"].MESSAGE_RECEIPT_UPDATED}`, agentUserId, messageReceipt);
    ...
    onMessageError(agentUserId, error) {
        this.callMessagePrint(ELoggerType.error, `>>> ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EConversationalAIAPIEvents"].MESSAGE_ERROR}`, agentUserId, error);
    ...
    onMessageSalStatus(agentUserId, message) {
        this.callMessagePrint(ELoggerType.debug, `>>> ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EConversationalAIAPIEvents"].MESSAGE_SAL_STATUS}`, agentUserId, message);
    ...
    _handleRtcAudioPTS(pts) {
        try {
            this.callMessagePrint(ELoggerType.debug, `<<< ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERTCEvents"].AUDIO_PTS}`, pts);
            this.covSubRenderController.setPts(pts);
        } catch (error) {
            this.callMessagePrint(ELoggerType.error, `<<< ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERTCEvents"].AUDIO_PTS}`, pts, error);
        }
    }
    _handleRtmMessage(message) {
        const traceId = genTranceID();
        this.callMessagePrint(ELoggerType.debug, `>>> [trancID:${traceId}] ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERTMEvents"].MESSAGE}`, `Publisher: ${message.publisher}, type: ${message.messageType}`);
        // Handle the message
        try {
            ...
            if (typeof messageData === 'string') {
                ...
                this.callMessagePrint(ELoggerType.debug, `>>> [trancID:${traceId}] ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERTMEvents"].MESSAGE}`, parsedMessage);
            ...
            this.callMessagePrint(ELoggerType.warn, `>>> [trancID:${traceId}] ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERTMEvents"].MESSAGE}`, 'Unsupported message type received');
        } catch (error) {
            this.callMessagePrint(ELoggerType.error, `>>> [trancID:${traceId}] ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERTMEvents"].MESSAGE}`, 'Failed to parse message', error);
        }
    }
    _handleRtmPresence(presence) {
        const traceId = genTranceID();
        this.callMessagePrint(ELoggerType.debug, `>>> [trancID:${traceId}] ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERTMEvents"].PRESENCE}`, `Publisher: ${presence.publisher}`);
        // Handle the presence event
        const stateChanged = presence.stateChanged;
        if (stateChanged?.state && stateChanged?.turn_id) {
            this.callMessagePrint(ELoggerType.debug, `>>> [trancID:${traceId}] ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERTMEvents"].PRESENCE}`, `State changed: ${stateChanged.state}, Turn ID: ${stateChanged.turn_id}, timestamp: ${presence.timestamp}`);
            this.covSubRenderController.handleAgentStatus(presence);
        }
        this.callMessagePrint(ELoggerType.debug, `>>> [trancID:${traceId}] ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERTMEvents"].PRESENCE}`, 'No state change detected, skipping handling presence event');
    }
    _handleRtmStatus(status) {
        const traceId = genTranceID();
        this.callMessagePrint(ELoggerType.debug, `>>> [trancID:${traceId}] ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERTMEvents"].STATUS}`, status);
    }
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__897481aa._.js.map