...
function ChatInterface({ product, onClose }) {
    ...
    const rtmInitializedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const [rtmReady, setRtmReady] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    // Handle RTM messages
    const handleRtmMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatInterface.useCallback[handleRtmMessage]": (message, senderId)=>{
            if (senderId === "1000" || senderId === agentId) {
                setMessages({
                    "ChatInterface.useCallback[handleRtmMessage]": (prev)=>[
                            ...prev,
                            {
                                role: "assistant",
                                content: message
                ...
                }["ChatInterface.useCallback[handleRtmMessage]"]);
            }
        }
    }["ChatInterface.useCallback[handleRtmMessage]"], [
        agentId
    ...
    // Initialize RTM once when config is ready
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatInterface.useEffect": ()=>{
            if (!agoraConfig || rtmInitializedRef.current || ("TURBOPACK compile-time value", "object") === "undefined") {
                return;
            }
            let isMounted = true;
            const initRTM = {
                "ChatInterface.useEffect.initRTM": async ()=>{
                    try {
                        ...
                        const client = new RTM(agoraConfig.appId, agoraConfig.rtmUserId);
                        ...
                        if (!isMounted) {
                            await client.logout().catch({
                                "ChatInterface.useEffect.initRTM": ()=>{}
                            }["ChatInterface.useEffect.initRTM"]);
                            return;
                        }
                        client.on("MessageFromPeer", {
                            "ChatInterface.useEffect.initRTM": (message, peerId)=>{
                                if (isMounted) {
                                    try {
                                        const payload = JSON.parse(message.text);
                                        if (payload.message) {
                                            handleRtmMessage(payload.message, peerId);
                                        }
                                    } catch (e) {
                                        handleRtmMessage(message.text || "", peerId);
                                    }
                                }
                            }
                        }["ChatInterface.useEffect.initRTM"]);
                        // Wait a bit for agent to be online before marking RTM as ready
                        setTimeout({
                            "ChatInterface.useEffect.initRTM": ()=>{
                                if (isMounted) {
                        ...
                        }["ChatInterface.useEffect.initRTM"], 2000);
                    } catch (error) {
            ...
            return ({
                "ChatInterface.useEffect": ()=>{
                    ...
                    if (rtmClientRef.current) {
                        ...
                        rtmInitializedRef.current = false;
                        setRtmReady(false);
                    }
                }
            })["ChatInterface.useEffect"];
    ...
    const sendMessage = async ()=>{
        if (!input.trim() || isLoading || !rtmClientRef.current || !rtmReady) return;
        ...
        try {
            ...
            await rtmClientRef.current.publish("1000", JSON.stringify(payload), {
                channelType: "USER",
            ...
            // If agent is offline, show helpful message
            if (error?.code === -11033 || error?.message?.includes("offline")) {
                setMessages((prev)=>[
                        ...prev,
                        {
                            role: "assistant",
                            content: "Agent is not ready yet. Please wait a moment and try again."
                        }
                    ]);
            } else {
                setMessages((prev)=>[
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            ...
                                            disabled: isLoading || isInitializing || !rtmReady,
                                            placeholder: !rtmReady ? "Waiting for agent..." : "Type your question..."
                                        }, void 0, false, {
                                            fileName: "[project]/components/ChatInterface.tsx",
                                            lineNumber: 468,
                                            columnNumber: 15
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            onClick: sendMessage,
                                            disabled: isLoading || !input.trim() || isInitializing || !rtmClientRef.current || !rtmReady,
                                            ...
                                            title: !rtmReady ? "Waiting for agent to be ready..." : "",
                                            children: "Send"
                                        }, void 0, false, {
                                            fileName: "[project]/components/ChatInterface.tsx",
                                            lineNumber: 479,
...
_s(ChatInterface, "7DfEN7lVft6EFt4OtFyd2+ohNoA=", false, function() {
    return [
...
//# sourceMappingURL=_e3f45079._.js.map