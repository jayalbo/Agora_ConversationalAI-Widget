...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$agora$2d$js$2f$report$2f$AgoraRTC_N$2d$report$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@agora-js/report/AgoraRTC_N-report.esm.mjs [app-client] (ecmascript) <locals>");
(()=>{
...
class ConversationalAIAPI extends EventHelper {
    ...
    constructor(){
        ...
        this.callMessagePrint = (type = ELoggerType.debug, ...args)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$agora$2d$js$2f$report$2f$AgoraRTC_N$2d$report$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["logger"][type](...args);
        };
            ...
            const initToolkit = {
                "ChatInterface.useEffect.initToolkit": async ()=>{
                    try {
                        ...
                        convoAPI.on(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$conversational$2d$ai$2d$api$2f$type$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EConversationalAIAPIEvents"].TRANSCRIPT_UPDATED, {
                            "ChatInterface.useEffect.initToolkit": (transcripts)=>{
                                if (!isMounted) return;
                                // Convert transcripts to chat messages
                                const newMessages = transcripts.map({
                                    "ChatInterface.useEffect.initToolkit.newMessages": (item)=>{
                                ...
                                }["ChatInterface.useEffect.initToolkit.newMessages"]);
                                // Update messages, removing duplicates by uid and turn_id
                                setMessages({
                                    "ChatInterface.useEffect.initToolkit": (prev)=>{
                                        const existing = new Map();
                                        prev.forEach({
                                            "ChatInterface.useEffect.initToolkit": (msg)=>{
...
_s(ChatInterface, "Xc2E2Xv05yXzCiHrgv/D6E4gGkw=", false, function() {
    return [
...
//# sourceMappingURL=_778e6356._.js.map